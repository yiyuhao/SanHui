...
class PersonnelInformation(models.Model):
    ...
    degree_of_education = models.CharField(verbose_name='文化程度', max_length=20, choices=(
        ('cz', '初中及以下'), ('gz', '高中'), ('dz', '大专'), ('bk', '本科'), ('ss', '硕士'), ('bs', '博士')))
    political_status = models.CharField(verbose_name='政治面貌', choices=(
        ('qz', '群众'), ('ty', '团员'), ('dy', '党员')))
    school_major_field = models.CharField(verbose_name='在读院校和专业', max_length=50)
    employment_intention = models.ForeignKey(EmploymentIntention, verbose_name='就业意向')
    ...
    working_years = models.CharField(verbose_name='务工年限', choices=(('1', '1年以下'), ('1to5', '1-5年'), ('5', '5年以上')))
    working_position = models.CharField(verbose_name='务工职位', choices=(('5', '5万以下'), ('5to8', '5-8万'), ('8to12', '8-12万'), ('12', '12万以上')))
    phone_num = models.CharField(verbose_name='联系方式', max_length=11, null=True, blank=True)
    health_status = models.CharField(verbose_name='健康状态', choices=(('healthy', '健康'), ('unhealthy', '患有疾病'), ('disabled', '残疾')))
